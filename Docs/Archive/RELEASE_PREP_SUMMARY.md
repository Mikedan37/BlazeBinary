...
- `Core/SPECIFICATION.md` - RFC-style specification (new)
- `Docs/ARCHITECTURE.md` - System architecture (new)
- `Docs/ENCODING_MODEL.md` - Encoding strategies (new)
- `Core/FRAME_PROTOCOL.md` - Frame protocol (new)
- `Security/THREAT_MODEL.md` - Threat analysis (new)
- `Performance/BENCHMARKS.md` - Performance data (new)
