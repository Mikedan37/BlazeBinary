...
struct FuzzStyleTests {
    ...
    @Test func testInvalidVarintTooManyBytes() throws {
    ...
    @Test func testInvalidVarintShiftOverflow() throws {
    ...
    @Test func testInvalidVarintTruncated() throws {
    ...
    @Test func testCorruptedFrameZeroLength() throws {
    ...
    @Test func testCorruptedFrameOversizedLength() throws {
    ...
    @Test func testCorruptedFrameTruncatedPayload() throws {
    ...
    @Test func testCorruptedFrameInvalidLengthPrefix() throws {
    ...
    @Test func testTruncatedUInt32() throws {
    ...
    @Test func testTruncatedUInt64() throws {
        // Only 4 bytes available for UInt64 (needs 8)
        let truncated = Data([0x01, 0x02, 0x03, 0x04])
        
        let decoder = BlazeBinaryDecoder(data: truncated)
        #expect(throws: BlazeBinaryError.truncated) {
            _ = try decoder.decodeUInt64()
        }
    }
    
    @Test func testTruncatedDataPayload() throws {
    ...
    @Test func testTruncatedStringPayload() throws {
        // Length prefix says 100 bytes, but only 50 available
        let encoder = BlazeBinaryEncoder()
    ...
    @Test func testTruncatedArray() throws {
    ...
    @Test func testMalformedBool() throws {
    ...
    @Test func testOversizedDataLength() throws {
