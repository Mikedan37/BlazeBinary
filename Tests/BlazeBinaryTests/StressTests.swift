...
@Test func testStressRoundTrip() throws {
...
@Test func testStressFrames() throws {
...
@Test func testStressMultipleFrames() throws {
    let parser = BlazeFrameParser()
    ...
    while let frame = try parser.nextFrame() {
        ...
        #expect(frame[0] == UInt8(decodedCount))
        decodedCount += 1
    }
    
    #expect(decodedCount == 100)
}
