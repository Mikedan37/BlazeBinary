...
#if canImport(CoreGraphics)
@Test func test_encode_decode_point() throws {
    ...
    #expect(roundTripResult)
}

@Test func test_encode_decode_large_point_array() throws {
    ...
    for i in 0..<points.count {
        #expect(decoded[i].x == points[i].x)
        #expect(decoded[i].y == points[i].y)
    }
...
#if canImport(CoreGraphics)
@Test func test_encode_decode_rect() throws {
    ...
    #expect(decoded.origin.x == rect.origin.x)
    #expect(decoded.origin.y == rect.origin.y)
    #expect(decoded.size.width == rect.size.width)
    #expect(decoded.size.height == rect.size.height)
...
@Test func test_encode_decode_string_dict() throws {
    ...
    #expect(emptyRoundTrip)
}

// MARK: - Round-Trip Consistency Tests

@Test func test_roundtrip_consistency() throws {
    #if canImport(CoreGraphics)
    // Test CGPoint
...
@Test func test_deterministic_encoding() throws {
    #if canImport(CoreGraphics)
...
@Test func test_continuation_request_round_trip() throws {
    ...
    #expect(decoded.textBefore == request.textBefore)
    ...
    #expect(longRoundTrip)
}

@Test func test_continuation_response_round_trip() throws {
    ...
    #expect(decoded.predictedText == response.predictedText)
    ...
    #expect(unicodeRoundTrip)
}

@Test func test_encoding_is_deterministic_across_runs() throws {
