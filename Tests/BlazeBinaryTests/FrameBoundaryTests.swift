...
struct FrameBoundaryTests {
    ...
    @Test func testFrameExactlyAtMaxSize() throws {
    ...
    @Test func testFrameOneByteOverMaxSize() throws {
    ...
    @Test func testFrameOneByteUnderMaxSize() throws {
    ...
    @Test func testBufferExactlyAtMaxSize() throws {
    ...
    @Test func testBufferOneByteOverMaxSize() throws {
    ...
    @Test func testFrameLengthPrefixAtBoundary() throws {
    ...
    @Test func testFrameLengthPrefixOneOverBoundary() throws {
    ...
    @Test func testMultipleFramesNearBufferLimit() throws {
    ...
    @Test func testFrameParserStateAfterNil() throws {
    ...
    @Test func testFrameParserAtomicExtraction() throws {
